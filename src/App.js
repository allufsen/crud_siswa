...
let url = "https://crudsiswaa-default-rtdb.";
          ...
          <table className="table mt-4">
            ...
            <tbody>
              {mahasiswas.map((mahasiswa) => (
                <RowMahasiswa key={mahasiswa.nim} mahasiswa={mahasiswa} onEditMahasiswa={handleEditMahasiswa} onHapusMahasiswa={handleHapusMahasiswa} />
              ))}
