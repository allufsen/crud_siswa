      ...
      {editStatus ? (
          ...
          <td colSpan="5">
            <form onSubmit={handleFormSubmit} onReset={handleFormReset}>
              <div className="row row-cols-5 g-3">
                <div className="col">
                  <input type="text" className="form-control" disabled defaultValue={formInput.nim} name="nama" />
                </div>
                <div className="col">
                ...
                <div className="col">
                  <input type="text" className="form-control" name="asalProvinsi" onChange={handleInputChange} value={formInput.asalProvinsi} />
        ...
        <tr>
          ...
          <td>
            ...
            <button className="btn btn-danger" id={props.mahasiswa.id} onClick={props.onHapusMahasiswa}>
              Hapus
            </button>
          </td>
        </tr>
